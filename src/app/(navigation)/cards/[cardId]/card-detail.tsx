...
export function CardDetail({ cardId }: { cardId: string }) {
  ...
  return (
    <div className="mx-auto w-full max-w-2xl px-4 py-8 sm:px-6">
      ...
      <article className="mt-4 overflow-hidden rounded-3xl border border-base-300 bg-base-100 shadow-md">
        <header className="relative overflow-hidden bg-linear-to-br from-primary/10 via-base-100 to-base-100 px-5 py-7 text-center sm:px-8">
          <div
          ...
          <div className="relative">
            ...
            <div className="mt-4 flex flex-wrap justify-center gap-1.5">
              {(card.commonTags ?? []).length > 0 ? (
                ...
                <span className="text-sm text-base-content/50">共通点なし</span>
              )}
            </div>
            ...
            {!card.opened && (
              <div className="mt-6">
                {openError && (
                  <ErrorAlert message={openError} className="mb-4 text-left" />
                )}
                <button
                  type="button"
        ...
        {card.opened && (
          <div className="space-y-7 border-t border-base-300 px-5 py-6 sm:px-8 sm:py-8">
